...
export default function Profile() {
    ...
    const formik = useFormik({
        ...
        validationSchema,
        onSubmit: values => {
            InstanceAxios().post(`https://webbanhangsieuvip.herokuapp.com/api/saler/updateShop`, values).then((response) => {
    ...
    useEffect(() => {
        async function fetchMyAPI() {
            if (session) {
                let provinceArr = await InstanceAxios().get(`https://webbanhangsieuvip.herokuapp.com/api/ghn/province`).then((data) => {
                ...
                await InstanceAxios().get(`https://webbanhangsieuvip.herokuapp.com/api/saler/getShopProfile`).then((data) => {
    ...
    async function getAddressCell(type, value, begin) {
        ...
        if (type != "") {
            ...
            result = await InstanceAxios().get(`https://webbanhangsieuvip.herokuapp.com/api/ghn/${type}` + param).then((data) => {
