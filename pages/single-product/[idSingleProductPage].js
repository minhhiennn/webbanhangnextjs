...
export default function SingleProduct({ data }) {
  ...
  useEffect(() => {
    const getReviewData = async () => {
      const res = await axios.get(`https://webbanhangsieuvip.herokuapp.com/api/product/getReviewByIdProduct`, { params: { idSingleProductPage: data.singleProductPage.idSingleProductPage } })
      if (res) {
    ...
    const getReviewReplyData = async () => {
      const res = await axios.get(`https://webbanhangsieuvip.herokuapp.com/api/product/getListEvaluateReplyResponse`, { params: { idSingleProductPage: data.singleProductPage.idSingleProductPage } })
      if (res) {
  ...
  const checkAddToCart = async () => {
    if (product != null) {
      ...
      const req = await instance().post(`https://webbanhangsieuvip.herokuapp.com/api/cart/addToCart`, { product, quantity: productQuantity.current.value })
        .catch((err) => {
...
export async function getStaticPaths() {
  ...
  const res = await instance().get(
    `https://webbanhangsieuvip.herokuapp.com/api/product/loadAllSingleProductPage`
  );
  if (res != undefined) {
...
export async function getStaticProps({ params }) {
  const res = await instance().get(
    `https://webbanhangsieuvip.herokuapp.com/api/product/getSingleProductPagePerPage/${params.idSingleProductPage}`
  );
  if (res != undefined) {
    let res1 = null;
    let res2 = null;
    ...
    await axios.all([
      instance().get(
        `https://webbanhangsieuvip.herokuapp.com/api/product/getListProductBySingleProductPage`,
        { params: { idSingleProduct: res.data.idSingleProductPage } }),
      instance().get(`https://webbanhangsieuvip.herokuapp.com/api/product/getListCategoryBySingleProductPage`,
        { params: { idCategory: res.data.idCategory } }),
      instance().get(`https://webbanhangsieuvip.herokuapp.com/api/product/getShopProfile`, { params: { idShop: res.data.idShop } })
