...
export default function ProductAddModal({ open, closeModal }) {
    ...
    const formik = useFormik({
        ...
        validationSchema,
        onSubmit: values => {
            InstanceAxios().post(`https://webbanhangsieuvip.herokuapp.com/api/saler/productSalerUpdate`, values).then((response) => {
    ...
    useEffect(() => {
        InstanceAxios().get(`https://webbanhangsieuvip.herokuapp.com/api/product/loadCagetory`)
            .then((data) => {
