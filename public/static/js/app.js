...
$(function () {
    ...
    $.scrollUp({
        ...
        scrollText: '<i><svg style="padding-top:15px" height="35" width="30" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="up-long" className="svg-inline--fa fa-up-long fa-2xs" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M285.1 145.7c-3.81 8.758-12.45 14.42-21.1 14.42L192 160.1V480c0 17.69-14.33 32-32 32s-32-14.31-32-32V160.1L55.1 160.1c-9.547 0-18.19-5.658-22-14.42c-3.811-8.758-2.076-18.95 4.408-25.94l104-112.1c9.498-10.24 25.69-10.24 35.19 0l104 112.1C288.1 126.7 289.8 136.9 285.1 145.7z"></path></svg></i>',
        easingType: 'linear',
        scrollSpeed: 900,
        animation: 'fade',
        zIndex: 100,
        ...
        if (settings.bodyBackDropOnScenes) {
            if (mode === 'landscape' && !listItembackDropFlag) {
                ...
                if ($('#app').find('.body-backdrop').length === 0) {
                    $('#app').append('<div className="body-backdrop"></div>\n');
                    // Assign Back Drop
...
(function ($, window, document) {
    ...
    const sliderMain = function () {
        ...
        $owl.owlCarousel({
            ...
            navText: ['<i><svg style="padding-top:10px" height="40" width="40" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-left" className="svg-inline--fa fa-angle-left " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z"></path></svg></i>', '<i><svg style="padding-top:10px" height="40" width="40" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" className="svg-inline--fa fa-angle-right " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M64 448c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L178.8 256L41.38 118.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160c12.5 12.5 12.5 32.75 0 45.25l-160 160C80.38 444.9 72.19 448 64 448z"></path></svg></i>'], // by default text prev, next will not show
        });
    ...
    const productSlider = function () {
        ...
        $productsSlider.on('initialize.owl.carousel', function () {
            ...
            thisInstance.owlCarousel({
                ...
                navText: ['<i><svg style="margin-top: 21px" height="40" width="40" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-left" className="svg-inline--fa fa-angle-left " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z"></path></svg></i>', '<i><svg  style="margin-top: 21px" height="40" width="40"aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" className="svg-inline--fa fa-angle-right " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M64 448c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L178.8 256L41.38 118.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160c12.5 12.5 12.5 32.75 0 45.25l-160 160C80.38 444.9 72.19 448 64 448z"></path></svg></i>'],
                responsive: {
                    0: {
                        items: 1,
                    },
        ...
        $('.price-slider-range').each(function () {
            ...
            $('.price-filter').slider({
                ...
                slide: function (event, ui) {
                    let result = '<div className="price-from">' + currecyUnit + ui.values[0] + '</div>\n<div className="price-to">' + currecyUnit + ui.values[1] + '</div>\n';
